...
export const EXCEL_STORE_MAP: Record<string, string> = {
  ...
  '新光三越': '台南新光三越西門店',
  '西門':     '台南新光三越西門店',
  // ── 高雄漢神本館店（漢神百貨本館，2026-09 開幕）──
  // ⚠️「本館」是 2 個字，跟下面的 '高雄'、'漢神' 同長度；同長度時「先出現的 key 贏」，
  //    所以這一段一定要留在通用的 '高雄'／'漢神' 之前，否則整間店的貨會算到高雄漢神巨蛋店或台中漢神中港店。
  '高雄漢神本館店': '高雄漢神本館店',
  '高雄漢神本館':   '高雄漢神本館店',
  '漢神本館':       '高雄漢神本館店',
  '本館':           '高雄漢神本館店',
  ...
  '三井':       '台南三井 Outlet 店',
  // ── 即將開幕門市：不補的話「台南SOGO新天店」會被「台南」誤判成小北門（長 key 優先，故放這幾個較長的）──
  '漢神百貨':   '高雄漢神本館店',   // 舊寫法，開幕前系統內叫「高雄漢神百貨店」
  'SOGO':       '台南 SOGO 新天店',
  'sogo':       '台南 SOGO 新天店',
  '新天':       '台南 SOGO 新天店',
