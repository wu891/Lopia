...
export const EXCEL_SHEET_ORDER = [
  '台中', '桃園', '中和', '新荘', '巨蛋',
  '南港', 'IKEA', '夢時', '北門', 'MOP', '中漢', '美麗', '西門', '本館', '北蛋'
]
...
export const STORES: Store[] = [
  ...
  { id: 'taipei-miramar', name_zh: '台北美麗華店', name_ja: '台北美麗華店', address_zh: '台北市中山區敬業三路20號 4F', city_zh: '台北', opened: '2026-07-09', status: 'open', excelSheetName: '美麗' },
  ...
  // 漢神百貨本館（成功一路266-1號 B3）。貨單／訊息上常寫「漢神本館」「本館」，別名見 parseDeliveryExcel.ts
  { id: 'kaohsiung-hanshin-dept', name_zh: '高雄漢神本館店', name_ja: '高雄漢神本館店', address_zh: '高雄市前金區成功一路266-1號 B3', city_zh: '高雄', opened: '2026-09-01', status: 'open', excelSheetName: '本館' },
